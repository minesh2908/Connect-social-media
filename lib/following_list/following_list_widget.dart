...
import 'following_list_model.dart';
export 'following_list_model.dart';
...
class _FollowingListWidgetState extends State<FollowingListWidget> {
  late FollowingListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FollowingListModel());
  }
              ...
              StreamBuilder<List<UsersRecord>>(
                stream: queryUsersRecord(
                  queryBuilder: (usersRecord) => usersRecord
                      .where('usersbeingfollowed', arrayContains: widget.user),
                ),
