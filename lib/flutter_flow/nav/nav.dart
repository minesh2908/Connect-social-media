...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/mainFeed',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MainFeed')
              : MainFeedWidget(),
        ),
        FFRoute(
          name: 'PublicProfile',
        ...
        FFRoute(
          name: 'PostComments',
          path: '/postComments',
          builder: (context, params) => PostCommentsWidget(
        ...
        FFRoute(
          name: 'DashboardGroup',
          path: '/dashboardGroup',
          builder: (context, params) => DashboardGroupWidget(),
        ),
        FFRoute(
          name: 'AddGroupPage',
          path: '/addGroupPage',
          builder: (context, params) => AddGroupPageWidget(),
        ),
        FFRoute(
          name: 'GroupPage',
          path: '/groupPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateGroupPostWidget(
            groupRef: params.getParam(
                'groupRef', ParamType.DocumentReference, false, ['Groups']),
          ),
        ),
        FFRoute(
          name: 'ModerateGroup',
          path: '/moderateGroup',
          builder: (context, params) => ModerateGroupWidget(
            groupRef: params.getParam(
                'groupRef', ParamType.DocumentReference, false, ['Groups']),
          ),
        ),
        FFRoute(
          name: 'ModeratorMembersList',
          path: '/moderatorMembersList',
          builder: (context, params) => ModeratorMembersListWidget(
            groupRef: params.getParam(
                'groupRef', ParamType.DocumentReference, false, ['Groups']),
          ),
        ),
        FFRoute(
          ...
          path: '/addPostToFeed',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddPostToFeed')
              : AddPostToFeedWidget(),
        ),
        FFRoute(
          name: 'SearchUser',
          path: '/searchUser',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SearchUser')
              : SearchUserWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
        ...
        FFRoute(
          name: 'FollowersList',
          path: '/followersList',
          builder: (context, params) => FollowersListWidget(
        ...
        FFRoute(
          name: 'FollowingList',
          path: '/followingList',
          builder: (context, params) => FollowingListWidget(
            user: params.getParam(
                'user', ParamType.DocumentReference, false, ['users']),
          ),
        )
