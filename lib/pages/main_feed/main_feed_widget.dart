            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                                      ...
                                      onTap: () async {
                                        ...
                                        await StoriesRecord.collection
                                          ...
                                          ...createStoriesRecordData(
                                            ...
                                            likes: 1,
                                            storyId: random_data.randomString(
                                              12,
                                              12,
                                              true,
                                              false,
                  ...
                  StreamBuilder<List<PostsRecord>>(
                    stream: queryPostsRecord(
                      queryBuilder: (postsRecord) =>
                          postsRecord.orderBy('DateCreated', descending: true),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                  ...
                  if ((currentUserDocument?.usersbeingfollowed?.toList() ?? [])
                          .length
                          .toString() ==
                      '0')
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                'https://cdn.dribbble.com/users/1520241/screenshots/9574747/empty-illustration_1.gif',
                                width: double.infinity,
