...
import '/components/update_post_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<int>(
      future: queryUsersRecordCount(
        queryBuilder: (usersRecord) => usersRecord.where('userFollowingMe',
                          ...
                          children: [
                              ...
                              child: FutureBuilder<int>(
                                future: queryUsersRecordCount(
                                  queryBuilder: (usersRecord) =>
                                      usersRecord.where('userFollowingMe',
                                          arrayContains: currentUserReference),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                            ...
                            Padding(
                              ...
                              child: FutureBuilder<int>(
                                future: queryUsersRecordCount(
                                  queryBuilder: (usersRecord) =>
                                      usersRecord.where('usersbeingfollowed',
                                          arrayContains: currentUserReference),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                              ...
                              child: StreamBuilder<List<GroupsRecord>>(
                                stream: queryGroupsRecord(
                                  queryBuilder: (groupsRecord) =>
                                      groupsRecord.where('Members_ref',
                                          arrayContains: currentUserReference),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  ...
                                  return Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('DashboardGroup');
                                      },
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        mainAxisAlignment:
                                        ...
                                        children: [
                                          AutoSizeText(
                                            formatNumber(
                                              containerGroupsRecordList.length,
                                              formatType: FormatType.compact,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                        ...
                        child: Column(
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                labelColor: Color(0xC20D8EED),
                                unselectedLabelColor: Color(0xC28BCBF8),
                                                                              ...
                                                                              RichText(
                                                                                text: TextSpan(
                                                                                  children: [
                                                                                    ...
                                                                                    TextSpan(
                                                                                      text: dateTimeFormat('relative', listViewPostsRecord.dateCreated!),
                                                                                      style: TextStyle(),
                                                                                    )
                                                                                  ],
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      formatNumber(
                                                                                        listViewPostsRecord.commentRef.length,
                                                                                        formatType: FormatType.compact,
                                                                                      ),
